...
//        jsonWaiterValues.append("{\"name\": \"" + w.getWaiterName() + "\", \"value\" :\"姓名\"},\n");
        jsonWaiterValues.append("{\"name\": \"memberID : " + w.getWaiterID() + "\", \"value\" :\"WaiterID\"},\n");
        jsonWaiterValues.append("{\"name\": \"Joined Date : " + w.getWaiterJoinDate() + "\", \"value\" :\"系统密码\"},\n");
        jsonWaiterValues.append("{\"name\": \"Phone : " + w.getWaiterPhoneNumber() + "\", \"value\" :\"手机号码\"},\n");
        jsonWaiterValues.append("{\"name\": \"CampusID : " + w.getWaiterIDCard() + "\", \"value\" :\"身份证号码\"},\n");
        jsonWaiterValues.append("{\"name\": \"Birthday : " + w.getWaiterBirthday().toString() + "\", \"value\" :\"生日\"},\n");
//                jsonWaiterValues.append("{\"name\": \"WaiterID\", \"value\": \"" + w.getWaiterID() + "\"},\n");
//                jsonWaiterValues.append("{\"name\": \"系统密码\", \"value\": \"" + w.getWaiterPassword() + "\"},\n");
//                jsonWaiterValues.append("{\"name\": \"手机号码\", \"value\": \"" + w.getWaiterPhoneNumber() + "\"},\n");
//                jsonWaiterValues.append("{\"name\": \"身份证号码\", \"value\": \"" + w.getWaiterIDCard() + "\"},\n");
